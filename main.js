function generateUSFacultyMap() {
    ...
    function ready (data) {
        ...
        let largestFacultyCount = getLargestFacultyNumber(usFaculty);
        let smallestFacultyCount = getSmallestFacultyNumber(usFaculty);
